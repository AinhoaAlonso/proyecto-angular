...
CREATE TABLE `appointments` (
  ...
  `requires_operating_room_appointments` tinyint NOT NULL,
  `status_appointments` enum('pendiente','confirmada','cancelada','realizada') NOT NULL,
  `cancellation_reason_appointments` longtext NOT NULL,
  `created_by_appointments` enum('admin','professional') NOT NULL,
...
CREATE TABLE `blocks_room_professionals` (
  ...
  CONSTRAINT `fk_id_professionals` FOREIGN KEY (`professionals_id`) REFERENCES `professionals` (`id_professionals`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patients` (
  ...
  `nif_patients` varchar(20) NOT NULL,
  ...
  PRIMARY KEY (`id_patients`,`user_id`),
...
CREATE TABLE `treatments` (
  ...
  `requires_operating_room_treatments` tinyint DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `rol_users` enum('admin','dentista') NOT NULL DEFAULT 'dentista',
...
-- Dump completed on 2025-05-27  1:04:01
