...
CREATE TABLE `appointments` (
  ...
  CONSTRAINT `fk_professionals` FOREIGN KEY (`professional_id`) REFERENCES `professionals` (`id_professionals`),
  CONSTRAINT `fk_treatments` FOREIGN KEY (`treatments_id`) REFERENCES `treatments` (`id_treatments`)
...
INSERT INTO `slots` VALUES (1,'09:00:00','09:30:00');
...
-- Dump completed on 2025-05-29 14:19:35
